...
public class ImageShowManager {
    ...
    public int getMemorySize(){
        ...
        //create
        //hit 返回值在缓存中的次数
        Log.i("Load","LruCache---putCount="+mMemoryCache.putCount()+"//missCount="+mMemoryCache.missCount()+"//evictionCount="+mMemoryCache.evictionCount()+"//createCount="+mMemoryCache.createCount()+"//hitCount="+mMemoryCache.hitCount());
        return mMemoryCache.size();
    }
    public int getDiskSize(){
        return mDiskCache.getCacheSize();
    }
